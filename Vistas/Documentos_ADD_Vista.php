...
?>
 ...
 <?php
			...
			echo "<form class=\"form-horizontal\" id=formulario method=\"post\" action=\"..\Controlador\Documentos_Controller.php?AltaDocumentos\">";
			...
			echo "<div class=\"form-group\"><label class=\"col-sm-2 control-label\" for=\"documento\"id =\"documento\"> ".$idiom['Documentos']."";
			echo "<div class=\"input-group col-sm-3\">";
			...
			echo "<a href=\"Documentos_Controller.php?AltaDocumentos\"><input type=\"image\" src=\"..\Archivos\añadir.png\" width=\"20\" height=\"20\"></a>";
			echo "</fieldset>";
			echo "</form>";

...
?>
 <?php
			...
			echo "<form enctype=\"multipart/form-data\" class=\"form-horizontal\" method=\"post\"  name=\"formulario\" id=\"formulario\" action=\"..\Controlador\Categoria_Controller.php?AltaCategoria\">";
			...
			echo"</select>";
			echo "</div></div>";
			echo "<a href=\"Categoria_Controller.php?AltaCategoria\"><input type=\"image\" src=\"..\Archivos\añadir.png\" width=\"20\" height=\"20\" mouseover='encriptar();'></a>";
			echo "</fieldset>";
			echo "</form>";

...
?>
 ...
 <?php
			...
			echo "</div></div>";
			echo "<div class=\"form-group\"><label class=\"col-sm-2 control-label\" for=\"usuario\"id =\"usuario\"> Usuario :</label>";
			echo "<div class=\"input-group col-sm-3\">";
			echo "<"."input"." "."class=\"form-control\""."type='number' required id='usuario' name='usuario'>";
			echo "</div></div>";
			echo "<div class=\"form-group\"><label class=\"col-sm-2 control-label\" for=\"espacio\"id =\"espacio\"> Espacio:</label>";
			echo "<div class=\"input-group col-sm-3\">";

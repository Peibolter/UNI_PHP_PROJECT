...
class InscripcionAlta{

	function crear($idioma,$resultado,$form, $formAlum, $formEvent, $mensaje){
...
?>
 <?php
			...
			echo "<form enctype=\"multipart/form-data\" class=\"form-horizontal\" method=\"post\"  name=\"formulario\" id=\"formulario\" action=\"..\Controlador\Inscripcion_Controller.php?AltaInscripcion\">";
			...
			echo"</select>";
			echo "</div></div>";
			echo "<a href=\"Inscripcion_Controller.php?AltaInscripcion\"><input type=\"image\" src=\"..\Archivos\añadir.png\" width=\"20\" height=\"20\" mouseover='encriptar();'></a>";
			echo "</fieldset>";
			echo "</form>";
